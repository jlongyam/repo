...
/**
 * TypeScript CLI application that processes command line arguments
 * Usage: node cli-app.ts [options] <command>
 */
...
function main(): number {
  ...
  if (parsed.options.help || parsed.options.h) {
    console.log(`
Usage: cli-app.ts [options] <command>
...
// Export for testing
export { parseArgs, main, type ParsedArgs, type TestResult }
